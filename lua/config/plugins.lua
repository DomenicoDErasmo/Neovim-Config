...
return {
  ...
  -- LeetCode problems inside Neovim
  {
    ...
    keys = {
      ...
      { "<leader>lr", "<cmd>Leet run<cr>", desc = "LeetCode run/test code" },
      { "<leader>ls", "<cmd>Leet submit<cr>", desc = "LeetCode submit" },
      { "<leader>lo", "<cmd>Leet console<cr>", desc = "LeetCode toggle console" },
      { "<leader>li", "<cmd>Leet info<cr>", desc = "LeetCode toggle info/hints" },
      { "<leader>ld", "<cmd>Leet desc<cr>", desc = "LeetCode toggle description" },
      { "<leader>ly", "<cmd>Leet yank<cr>", desc = "LeetCode yank code" },
      { "<leader>lR", "<cmd>Leet reset<cr>", desc = "LeetCode reset code" },
      { "<leader>lg", "<cmd>Leet lang<cr>", desc = "LeetCode change language" },
      { "<leader>lL", "<cmd>Leet last_submit<cr>", desc = "LeetCode restore last submission" },
      { "<leader>lD", "<cmd>Leet daily<cr>", desc = "LeetCode question of the day" },
      { "<leader>lz", "<cmd>Leet random<cr>", desc = "LeetCode random question" },
    },
    config = cfg("leetcode"),
  },
